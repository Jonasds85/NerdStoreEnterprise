    ...
    public class CarrinhoCliente
    {
        ...
        internal void AdicionarItem(CarrinhoItem item)
        {
            ...
            if (CarrinhoItemExistente(item))
            {
                ...
                itemExistente.AdicionaUnidades(item.Quantidade);
        ...
        {
            ValorTotal = Itens.Sum(p => p.CalcularValorItem());
        ...
        internal void AtualizaItem(CarrinhoItem item)
        {
            item.AssociarCarrinho(Id);
        ...
        {
            Itens.Remove(ObterItemPorProdutoId(item.ProdutoId));
            CalcularValorCarrinho();
        }
